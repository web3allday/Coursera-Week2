...
class Contact extends Component {
   ...
   validate(firstname, lastname, telnum, email) {
      ...
      if (this.state.touched.firstname && firstname.length < 3)
         ...
         const reg = /^\d+$/;
         if (this,this.state.touched.telnum && !reg.test(telnum))
          errors.telnum = "Tel No should only include numbers";
               ...
               <div className="col-12 col-md-9">
                  ...
                  <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                           ...
                           <Col md={10}>
                              <Input type="text" id="telnum" name="telnum" placeholder="Tel No." value={this.state.telnum} 
                              valid={errors.telnum === ''}
